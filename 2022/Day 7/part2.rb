...
currentlyAvailable = MAX_AVAILABLE - $finalisedDirSizes["/"]
minDeletion = MIN_REQUIRED - currentlyAvailable

deleteDirSize = $finalisedDirSizes.select { |key, value| value >= minDeletion }.min_by { |key, value| value }[1]
puts"#{deleteDirSize}"