...
private:
	...
	const std::string testFile2_1 = "inputs/day10_part2_test1.txt";
	const std::string testFile2_2 = "inputs/day10_part2_test2.txt";
	const std::string testFile2_3 = "inputs/day10_part2_test3.txt";
	const std::string testFile2_4 = "inputs/day10_part2_test4.txt";
